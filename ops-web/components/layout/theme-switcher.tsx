  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        onClick={() => setOpen((o) => !o)}
        aria-label="切换主题色"
        className="flex h-8 items-center gap-1.5 rounded-field bg-secondary px-2.5 text-muted-foreground transition-colors hover:bg-accent hover:text-foreground"
      >
