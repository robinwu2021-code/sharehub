...
export const systemMock: SystemApi = {
  ...
  listBrands: (q = {}) => wait(db.listBrands(q)),
  saveBrand: async (x) => wait(db.saveBrand(x), 350),
  archiveBrand: async (no) => wait(db.archiveBrand(no), 350),
  unarchiveBrand: async (no) => wait(db.unarchiveBrand(no), 350),
