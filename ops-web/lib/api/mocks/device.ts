...
export const deviceMock: DeviceApi = {
  ...
  confirmPowerbankLost: async (no, note) => wait(da.confirmPowerbankLost(no, note), 300),
  dismissPowerbankLost: async (no, note) => wait(da.dismissPowerbankLost(no, note), 300),
