// 契约一致性单测：161 个方法靠人眼查不出漏实现，这里用集合运算兜住。
//
// 三条防线：
...
const API_METHODS: Record<string, readonly string[]> = {
  ...
  pricing: ["listPricePlans", "listPricingDiffs", "listPricingSchedules", "savePricePlan", "savePricingDiff", "savePricingSchedule"],
  finance: ["listShareRules", "listLedger", "listSettlements", "listWithdrawals", "auditWithdrawal", "listShareRecords", "listReconciles", "listInvoices", "saveShareRule", "saveInvoice", "listShareSummaries", "listRechargeOrders"],
  user: ["listUsers", "setBlacklist", "listMembers", "listWallets", "saveMember", "saveWallet", "listConsumerSegments", "listUserRisks", "listUserBlacklist", "listFreeWhitelist", "saveFreeWhitelist", "revokeFreeWhitelist", "listRechargePackages", "saveRechargePackage"],
