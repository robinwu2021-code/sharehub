...
describe("域切片划分", () => {
  ...
  it("方法总数仍为 333（新增/删除 API 时须自觉更新此数）", () => {
    ...
    //   + 终止申请与其审批 + 续签/补充协议）。
    expect(ALL_METHODS.length).toBe(333);
  });
});
