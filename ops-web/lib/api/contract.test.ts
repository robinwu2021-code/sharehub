...
describe("域切片划分", () => {
  ...
  it("方法总数仍为 367（新增/删除 API 时须自觉更新此数）", () => {
    ...
    expect(ALL_METHODS.length).toBe(401);
  });
});
