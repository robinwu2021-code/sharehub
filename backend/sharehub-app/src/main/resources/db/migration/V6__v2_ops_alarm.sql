-- 自动生成，勿手改：源文件 docs/technical/ddl/pb_core-v2-ops-alarm.sql
...
-- 告警记录（聚合根）
CREATE TABLE IF NOT EXISTS dev_alarm (
...
CREATE TABLE IF NOT EXISTS dev_alarm_notice (
  id          BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS dev_alarm_code (
  id              BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
...
-- 告警通知规则（静默窗口 + 升级策略）
CREATE TABLE IF NOT EXISTS dev_alarm_rule (
  id               BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
...
-- ============================================================
CREATE TABLE IF NOT EXISTS dev_code_batch (
  id          BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
...
-- BD 拓展 CRM 商机
CREATE TABLE IF NOT EXISTS loc_lead (
  id             BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
...
-- 门店自助进件
CREATE TABLE IF NOT EXISTS loc_venue_onboarding (
  id             BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS loc_site_lifecycle (
  id         BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  tenant_id  VARCHAR(36)  NOT NULL DEFAULT 'MAIN',
...
CREATE TABLE IF NOT EXISTS loc_site_lifecycle_log (
  id         BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  tenant_id  VARCHAR(36)  NOT NULL DEFAULT 'MAIN',
...
--       ADD COLUMN IF NOT EXISTS agent_name  VARCHAR(128) NULL COMMENT '冗余展示名(写入时快照,不回溯)',
--       ADD COLUMN IF NOT EXISTS login_phone VARCHAR(32)  NULL COMMENT '登录手机(掩码;明文落 pii)';
-- ============================================================

-- 设备/点位划拨记录（append，无 version/deleted）
CREATE TABLE IF NOT EXISTS agt_assignment (
  id          BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
...
-- 代理分润配置
CREATE TABLE IF NOT EXISTS agt_commission (
  id            BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS agt_agent_region (
  id         BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  tenant_id  VARCHAR(36)  NOT NULL DEFAULT 'MAIN',
  agent_no   VARCHAR(36)  NOT NULL                COMMENT '代理商',
...
-- ============================================================
CREATE TABLE IF NOT EXISTS wo_sla_rule (
  id            BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
