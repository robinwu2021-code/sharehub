-- 自动生成，勿手改：源文件 docs/technical/ddl/pb_core-trade-finance.sql
...
-- ---------- D6 订单 ord_ ----------
CREATE TABLE IF NOT EXISTS ord_rent (
...
CREATE TABLE IF NOT EXISTS ord_event_log (
  id          BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  order_no    VARCHAR(36) NOT NULL,
...
CREATE TABLE IF NOT EXISTS pay_auth (
  id              BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS pay_event_log (
  id          BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS share_rule (
  id         BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  rule_no    VARCHAR(36) NOT NULL,
  tenant_id  VARCHAR(36) NOT NULL DEFAULT 'MAIN',
