-- 自动生成，勿手改：源文件 docs/technical/ddl/pb_core-v2-trade-user.sql
...
-- 异常订单（菜单：订单管理·异常订单）
CREATE TABLE IF NOT EXISTS ord_exception (
...
CREATE TABLE IF NOT EXISTS ord_complaint (
  id             BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
...
-- 预约订单（菜单：订单管理·预约订单）
CREATE TABLE IF NOT EXISTS ord_reservation (
  id             BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS ord_deposit (
  id             BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS price_plan_scope (
  id         BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  tenant_id  VARCHAR(36) NOT NULL DEFAULT 'MAIN',
...
CREATE TABLE IF NOT EXISTS stl_settlement_detail (
  id         BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  tenant_id  VARCHAR(36) NOT NULL DEFAULT 'MAIN',
...
CREATE TABLE IF NOT EXISTS usr_blacklist (
  id             BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS usr_free_whitelist (
  id           BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS usr_recharge_pkg (
  id          BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS usr_recharge_pkg_market (
  id           BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  tenant_id    VARCHAR(36) NOT NULL DEFAULT 'MAIN',
  package_no   VARCHAR(36) NOT NULL,
...
CREATE TABLE IF NOT EXISTS usr_recharge_order (
  id            BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS mkt_notice (
  id           BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
...
-- 推送触达（菜单：营销管理·推送）
CREATE TABLE IF NOT EXISTS mkt_push (
  id         BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS usr_push_token (
  id         BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  tenant_id  VARCHAR(36)  NOT NULL DEFAULT 'MAIN',
  c_user_no  VARCHAR(36)  NOT NULL,
...
CREATE TABLE IF NOT EXISTS usr_notify_pref (
  id          BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  tenant_id   VARCHAR(36) NOT NULL DEFAULT 'MAIN',
  c_user_no   VARCHAR(36) NOT NULL,
...
-- 发票抬头（C-IV-02）
CREATE TABLE IF NOT EXISTS usr_invoice_title (
  id         BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS usr_invoice (
  id         BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  invoice_no VARCHAR(36)  NOT NULL,
  tenant_id  VARCHAR(36)  NOT NULL DEFAULT 'MAIN',
  c_user_no  VARCHAR(36)  NOT NULL,
...
CREATE TABLE IF NOT EXISTS usr_logoff (
  id            BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  tenant_id     VARCHAR(36) NOT NULL DEFAULT 'MAIN',
  c_user_no     VARCHAR(36) NOT NULL,
...
-- ============================================================
-- §十 属主查询索引（C端）：
-- ALTER TABLE usr_coupon     ADD KEY IF NOT EXISTS idx_coupon_owner (tenant_id, c_user_no, created_at);
-- ALTER TABLE usr_wallet_txn ADD COLUMN IF NOT EXISTS c_user_no VARCHAR(36) NOT NULL,
--                            ADD KEY IF NOT EXISTS idx_wtxn_owner (wallet_no, c_user_no, created_at);
-- ALTER TABLE ord_rent       ADD KEY IF NOT EXISTS idx_ord_owner (tenant_id, c_user_no, created_at);
-- §1.5 金额必带币种：
-- ALTER TABLE coupon_tpl     ADD COLUMN IF NOT EXISTS currency VARCHAR(8) NOT NULL DEFAULT 'AED';
-- §5.2 price_rule 补齐 v2 关键列：
-- ALTER TABLE price_rule ADD COLUMN IF NOT EXISTS dimension VARCHAR(16) NOT NULL DEFAULT 'SITE' COMMENT 'SCENE/LOCATION/SITE',
--   ADD COLUMN IF NOT EXISTS match_ref VARCHAR(64) NULL, ADD COLUMN IF NOT EXISTS location_name VARCHAR(128) NULL,
--   ADD COLUMN IF NOT EXISTS free_mins INT NULL, ADD COLUMN IF NOT EXISTS unit_price DECIMAL(18,2) NULL,
--   ADD COLUMN IF NOT EXISTS day_cap DECIMAL(18,2) NULL, ADD COLUMN IF NOT EXISTS currency VARCHAR(8) NOT NULL DEFAULT 'AED';
...
-- ============================================================
CREATE TABLE IF NOT EXISTS mbr_plan (
  id            BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
