...
CREATE TABLE gw_device_binding (
  id          BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  sn          VARCHAR(64) NOT NULL,
  cabinet_no  VARCHAR(36)     NULL,
