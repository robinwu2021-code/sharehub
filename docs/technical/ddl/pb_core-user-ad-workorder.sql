...
CREATE TABLE wo_inspection_plan (
  id          BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  plan_no     VARCHAR(36) NOT NULL,
  tenant_id   VARCHAR(36) NOT NULL DEFAULT 'MAIN',
...
-- CREATE TABLE pii_user ( id ..., c_user_no VARCHAR(36), tenant_id VARCHAR(36),
...
-- CREATE TABLE cred_credential ( id ..., cred_no VARCHAR(36), realm VARCHAR(16) /*STAFF/CONSUMER/AGENT*/,
