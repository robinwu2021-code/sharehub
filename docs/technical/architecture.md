...
> 🧭 **2026-09-23 起，架构入口改为 [技术架构方案-v4](./技术架构方案-v4.md)**（[ADR-020](./ADR/ADR-020-单体优先-支付与协议对接独立部署.md)，待确认）：单体优先 + 支付共享 ai-shop pay 模块 + 协议对接独立部署 + 认证基于 neargo 与 ai-shop 方案。本文 §4 部署 / §7 支付 / §13 工程结构以 v4 为准。
>
