...
<template>
  <pb-scaffold tab="home">
    <view class="px-[32rpx] pt-[40rpx]">
      ...
      <view v-if="view === 'map'" class="mt-[20rpx]"><pb-map :points="list" @select="openStore" /></view>

      <view class="mt-[20rpx] flex flex-col gap-[24rpx]">
        <view v-for="(c, i) in list" v-show="view === 'list'" :key="c.cabinetNo" class="pb-rise" :style="{ animationDelay: i * 50 + 'ms' }" @tap="openStore(c)">
          <pb-card>
